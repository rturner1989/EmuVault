...
`install.sh` handles first-time setup: generates a `.env` file with a secure random database password, builds containers, creates the database, runs migrations, and seeds emulator profiles.
